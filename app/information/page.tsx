...
<h3 className="text-center font-bold text-red-600 p-4 bg-gray-300">PERSONAL INFORMATION:</h3>
<div className="border-4 border-solid border-black m-20 p-6 w-[300px] leading-relaxed">
    <h3>Father Name : Ghulam Rabbani</h3>
    <h3>Date of Birth : 15-06-1999</h3>
    <h3>Nationality : Pakistani</h3>
    <h3>Gender : Female</h3>
    <h3>Language : English, Urdu, Kashmiri(Hindko)</h3>
</div>
